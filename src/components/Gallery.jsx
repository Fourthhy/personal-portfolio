    ...
    return (
      <div className="galleryGrid ">
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG1.jpg)',
          ...
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG2.jpg)',
          ...
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG3.jpg)',
              'backgroundPositionY': 'center',
               'backgroundPositionX': 'center'
            }}>
          </div>
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG4.jpg)',
              'backgroundPositionY': 'center',
               'backgroundPositionX': 'center'
            }}>
          </div>
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG5.jpg)',
              'backgroundPositionY': 'center',
               'backgroundPositionX': 'center'
            }}>
          </div>
          <div className="galleryIMG" 
            style={{
              'backgroundImage': 'url(/images/gallery/GalleryIMG6.jpg)',
              'backgroundPositionY': 'center',
              'backgroundPositionX': 'center'
            }}>
          </div>
...
function ImageSet1() {
  return(
    <div className="galleryGrid ">
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG7.jpg)',
      ...
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG8.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG9.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG10.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG11.jpg)',
      ...
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG12.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
...
function ImageSet2() {
  return(
    <div className="galleryGrid ">
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG13.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG14.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG15.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG16.jpeg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
      <div className="galleryIMG" 
        style={{
          'backgroundImage': 'url(/images/gallery/GalleryIMG17.jpg)',
          'backgroundPositionY': 'center',
          'backgroundPositionX': 'center'
        }}>
      </div>
    ...
    <>
      <div className="galleryContainer">
        <div className="galleryHeader">
          <p class="text"> Memorable Images</p>
